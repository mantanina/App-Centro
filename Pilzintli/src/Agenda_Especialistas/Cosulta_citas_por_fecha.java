 ...
 * @author Havst
 */
public class Cosulta_citas_por_fecha extends javax.swing.JFrame {

    /**
     * Creates new form Cosulta_citas_especialistas
     */
    public Cosulta_citas_por_fecha() throws SQLException, IOException {
        initComponents();
    ...
    public void buscaFecha() throws SQLException {
        ...
        String fechaInicial = formato.format(fecha);
        ...
        String sql = "SELECT fecha,hora,paciente_id,especialista_id,tipo_consulta_id,terapia_id FROM consulta WHERE fecha BETWEEN '" + fechaInicial+ "' AND'"+ fechaFinal+ "'";// where fecha="+fech;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Citas por rango fecha");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Cosulta_citas_por_fecha().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Cosulta_citas_por_fecha.class.getName()).log(Level.SEVERE, null, ex);
                } catch (IOException ex) {
                    Logger.getLogger(Cosulta_citas_por_fecha.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
